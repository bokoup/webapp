...
export default function QRCodeModal({ data, open, setOpen }: QRCodeModalProps) {
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-md">
                  ...
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      <Dialog.Title as="h3" className="text-lg font-medium leading-6 text-gray-900">
                        Scan to receive {data ? data.promoName : ""}
                      </Dialog.Title>
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Scan the QR code and approve transaction with your mobile app to receive the promo.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  <button
                    type="button"
                    className="px-6 py-2 rounded-full bg-bokoupDark2-100 hover:brightness-90 font-semibold"
