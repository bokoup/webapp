...
export type MerchantItemQueryDocumentQuery = { __typename?: 'query_root', merchantByPk?: { __typename?: 'Merchant', id: string, owner: string, name: string, active: boolean, metadataJson?: any | null, locations: Array<{ __typename?: 'Location', id: string, merchant: string, name: string, active: boolean, metadataJson?: any | null, devicesAggregate: { __typename?: 'DeviceAggregate', aggregate?: { __typename?: 'DeviceAggregateFields', count: number } | null }, devices: Array<{ __typename?: 'Device', id: string, owner: string, location: string, name: string, active: boolean, metadataJson?: any | null }> }>, campaigns: Array<{ __typename?: 'Campaign', id: string, merchant: string, name: string, active: boolean, metadataJson?: any | null, campaignLocations: Array<{ __typename?: 'CampaignLocation', locationObject?: { __typename?: 'Location', devicesAggregate: { __typename?: 'DeviceAggregate', aggregate?: { __typename?: 'DeviceAggregateFields', count: number } | null } } | null }>, promos: Array<{ __typename?: 'Promo', id: string, mint: string, campaign: string, maxMint?: number | null, maxBurn?: number | null, mintCount: number, burnCount: number, active: boolean, createdAt: any, metadataObject?: { __typename?: 'Metadata', id: string, name: string, symbol: string, uri: string, metadataJson?: any | null } | null, mintObject?: { __typename?: 'Mint', id: string, supply: any } | null, campaignObject?: { __typename?: 'Campaign', campaignLocations: Array<{ __typename?: 'CampaignLocation', locationObject?: { __typename?: 'Location', devices: Array<{ __typename?: 'Device', id: string, owner: string, location: string }> } | null }> } | null }> }> } | null };
...
export type DeviceItemQueryDocumentQueryVariables = Exact<{
  id: Scalars['String'];
}>;


export type DeviceItemQueryDocumentQuery = { __typename?: 'query_root', deviceByPk?: { __typename?: 'Device', id: string, name: string, owner: string, uri: string, active: boolean, metadataJson?: any | null, locationObject?: { __typename?: 'Location', id: string, metadataJson?: any | null } | null } | null };
...
export type CampaignIdQueryDocumentQuery = { __typename?: 'query_root', campaign: Array<{ __typename?: 'Campaign', id: string }> };
...
export type MerchantPromoListQueryDocumentQuery = { __typename?: 'query_root', promo: Array<{ __typename?: 'Promo', id: string, campaign: string, maxMint?: number | null, maxBurn?: number | null, mintCount: number, burnCount: number, active: boolean, createdAt: any, campaignObject?: { __typename?: 'Campaign', merchant: string, name: string, merchantObject?: { __typename?: 'Merchant', metadataJson?: any | null } | null } | null, metadataObject?: { __typename?: 'Metadata', id: string, name: string, symbol: string, uri: string, metadataJson?: any | null } | null, mintObject?: { __typename?: 'Mint', id: string, supply: any } | null }> };
...
export type PromoIdQueryDocumentQuery = { __typename?: 'query_root', promo: Array<{ __typename?: 'Promo', id: string }> };

export type MintPromoTxIdQueryDocumentQueryVariables = Exact<{
  memo?: InputMaybe<Scalars['jsonb']>;
}>;
...
export const DeviceItemQueryDocumentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"DeviceItemQueryDocument"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deviceByPk"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"owner"}},{"kind":"Field","name":{"kind":"Name","value":"uri"}},{"kind":"Field","name":{"kind":"Name","value":"active"}},{"kind":"Field","name":{"kind":"Name","value":"metadataJson"}},{"kind":"Field","name":{"kind":"Name","value":"locationObject"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"metadataJson"}}]}}]}}]}}]} as unknown as DocumentNode<DeviceItemQueryDocumentQuery, DeviceItemQueryDocumentQueryVariables>;
...
export const DeviceIdQueryDocumentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"DeviceIdQueryDocument"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"location"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"name"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"timestamp"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"timestamptz"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"device"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_and"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"location"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"location"}}}]}}]}},{"kind":"ObjectField","name":{"kind":"Name","value":"name"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"name"}}}]}},{"kind":"ObjectField","name":{"kind":"Name","value":"modifiedAt"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_gt"},"value":{"kind":"Variable","name":{"kind":"Name","value":"timestamp"}}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<DeviceIdQueryDocumentQuery, DeviceIdQueryDocumentQueryVariables>;
