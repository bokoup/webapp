...
export type MerchantPromoListQueryDocumentQuery = { __typename?: 'query_root', promo: Array<{ __typename?: 'Promo', id: string, campaign: string, maxMint?: number | null, maxBurn?: number | null, mintCount: number, burnCount: number, active: boolean, createdAt: any, campaignObject?: { __typename?: 'Campaign', merchant: string, name: string } | null, metadataObject?: { __typename?: 'Metadata', id: string, name: string, symbol: string, uri: string, metadataJson?: any | null } | null, mintObject?: { __typename?: 'Mint', id: string, supply: any } | null }> };
